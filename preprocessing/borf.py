...
def borf3(data, loops=3, remove_edges=True, removal_bound=0.5, tau=1,
...
def borf4(data, loops=3, remove_edges=True, is_undirected=False, batch_add=4, batch_remove=2, 
